...
extern bool showEnemyStatus;
extern bool showPlayerStatus;
extern int damageToShow;
extern int textToShow;
extern int enemyStatusToShow;
extern int playerStatusToShow;
extern Vector2 damagePosition;
extern Vector2 textPosition;
extern Vector2 enemyStatusTextPosition;
extern Vector2 playerStatusTextPosition;
extern float animationTimer;
extern float damageDisplayTime;
extern float enemyStatusDisplayTime;
extern float playerStatusDisplayTime;
