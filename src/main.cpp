...
void GameRender() {
    ...
    DrawRectangle(5, 5, 330, 120, Fade(SKYBLUE, 0.05f));
    DrawRectangleLines(5, 5, 330, 120, DARKBLUE);
    ...
    DrawText(TextFormat("Plyaer XP: %d", player.experience), 15, 50, 14, WHITE);
...
void BattleRender() {
    DrawRectangle(100, 100, 600, 800, DARKGRAY);
